...
class Resize(MMCV_Resize):
    ...
    def transform(self, results: dict) -> dict:
        ...
        """
        # if results['img_order_of_classes'] == (0,39):
        #     # results['scale'] = (results['ori_shape'][0],results['ori_shape'][1])
        #     # results['scale_factor'] = (1.0,1.0)
        #     ratio = random.uniform(1, 4.5)
        #     # ratio = 1.0
        #     w = results['ori_shape'][0]
        #     h = results['ori_shape'][1]
        #     results['scale'] = (w*ratio,h*ratio)
...
class RandomFlip(MMCV_RandomFlip):
    ...
    def _flip(self, results: dict) -> None:
        ...
        # if results['img_order_of_classes'] == (40,79):
        # flip image
