...
config_path="configs/ior/ior_non_cooccurence_70_10_setting_each_class_10"
config_name_task1="gfl_r50_fpn_1x_coco_first_70_cats.py"
config_name_task2="gfl_r50_fpn_1x_coco_incre_71-80_cats_unrepeated.py"

generated_numImages_per_class=10

generated_path="./results_generated/ior_non_cooccurence_70_10_setting"
generated_folder_name1="first_70_cats_each_class_$generated_numImages_per_class"

agumented_replay_output_name="augemented_replay_70_10_setting"
ori_annotation_json_name="instances_train2017_ior_sel_last_10_cats_non_cooccurence"

model_save_path="results/ior_non_cooccurence_70_10_setting_each_class_10"
model_save_name_task1="ior_coco_first_70_cats"
model_save_name_task2="ior_coco_incre_71-80_cats"
# train 1-70
...
python tools/inversion/main_gfl_generate_statictis_coco.py --save_path "$generated_path/generated_sample/$generated_folder_name1" \
                                                            ...
                                                            --bs 70
python tools/inversion/agumented_replay_full_image.py --anno_file "$coco_dataset_path/annotations/${ori_annotation_json_name}.json" \
