...
def compute_overlap(a, b, thr=0.3):
...
def torch_random_cycle(gen_name_list, generate_img_path, generate_label_path, order_of_classes):
    ...
    while True:
        ...
        for idx in indices:
            ...
            # cropped_img.save('/data1/home/anzijia/coco/1.jpg')  
            yield cropped_img, bbox_cat_id
