...
def sel_cat(anno_file, sel_num):
    ...
    # writing results
    fp = open(os.path.splitext(anno_file)[0] + '_ior_sel_first_50_cats.json', 'w')
    ...
    sel_dataset['images'] = sel_images
    # writing results
    fp = open(os.path.splitext(anno_file)[0] + '_ior_sel_last_30_cats_non_cooccurence.json', 'w')
    json.dump(sel_dataset, fp)
